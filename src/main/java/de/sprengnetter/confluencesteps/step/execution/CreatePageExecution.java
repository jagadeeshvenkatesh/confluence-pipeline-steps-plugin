package de.sprengnetter.confluencesteps.step.execution;

import java.util.Collections;
import java.util.Locale;
import org.jenkinsci.plugins.workflow.steps.StepContext;
import de.sprengnetter.confluencesteps.ConfluenceSite;
import de.sprengnetter.confluencesteps.api.Ancestor;
import de.sprengnetter.confluencesteps.api.Body;
...
import de.sprengnetter.confluencesteps.api.Space;
import de.sprengnetter.confluencesteps.api.Storage;
import de.sprengnetter.confluencesteps.service.ContentService;
import de.sprengnetter.confluencesteps.step.AbstractStepExecution;
import de.sprengnetter.confluencesteps.step.descriptor.CreatePageStep;
...
public class CreatePageExecution extends AbstractStepExecution<PageCreated, CreatePageStep> {
    ...
    private Page toPage() {
        ...
        switch (getStep().getBy().getValue().toLowerCase(Locale.ENGLISH)) {
        case "title":
