...
import de.sprengnetter.confluencesteps.service.BaseService;
...
public abstract class AbstractStepExecution<R, T extends AbstractStep> extends SynchronousNonBlockingStepExecution<R> {
     ...
     * {@link de.sprengnetter.confluencesteps.service.ContentService}
    ...
    private synchronized void initClient(final ConfluenceSite confluenceSite) {
